...
def old_exp_M(cohr_flag: bool = False, power_doa_db: np.ndarray = np.array([0, 0, -5]), doa: np.ndarray = np.array([35.25, 43.25, 51.25]),
           basedir:str = '') -> None:
    ...
    fig_runtime_boxplot = create_figure_iterruntime_boxplot(results, param_vals=vec_m, param_name='M', DO_BOXPLOT=True)
    fig_runtime_violin = create_figure_iterruntime_boxplot(results, param_vals=vec_m, param_name='M', DO_BOXPLOT=False)
